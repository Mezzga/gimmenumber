...
class BusinessSignupController: UIViewController,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,FPNTextFieldDelegate {
    ...
    func register(){
        ...
        Parameters["company_name"] = txtCompanyName.text!
        Parameters["address"] = txtAddress.text!
        Parameters["mobile"] = mobile
        print(Parameters)
        btnSignUp.showLoading()
        Alamofire.request(
            URL_Businessregister ,
            method: .post,
